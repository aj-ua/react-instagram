...
const People = ({ users, currentUser, handleFollow }) => {
    const followingUsers = currentUser.following
    const filteredUsers = users.filter(user => !followingUsers.includes(user.id))
...
export default connect(mapStateToProps, { handleFollow })(People)
